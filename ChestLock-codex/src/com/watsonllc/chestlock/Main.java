...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
        ...
        Object correctConfigVersion = "1.4.0";
		...
		if (!correctConfigVersion.equals(currentConfigVersion) || currentConfigVersion == null) {
			...
			getLogger().severe("#            need help? discord.gg/BGurTEm2nj           #");
			getLogger().severe("#########################################################");
			return;
		}
			...
			try {
				...
				if (updater.checkForUpdates()) {
					String versionsCheck = "#                   %1.1.1% ----> %0.0.0%                   #"
							.replace("%0.0.0%", updater.getNewVersion()).replace("%1.1.1%", currentVersion);
					getLogger().warning("#########################################################");
					...
					getLogger().warning("#         need help? discord.gg/BGurTEm2nj     #");
					getLogger().warning("#########################################################");
				} else {
